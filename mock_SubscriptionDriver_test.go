...
type SubscriptionDriverMocker struct {
	...
	ListenForDeliveries    func(a0 context.Context) (accept func(context.Context, chan<- Delivery) error, err error)
}
...
func (d SubscriptionDriverMockDescriptor) done() func(t interface {
	...
	if len(d.descriptors_ListenForDeliveries) > 0 {
		for _, desc := range d.descriptors_ListenForDeliveries {
			...
			calls := 0
			prev := desc.call
			desc.call = func(a0 context.Context) (accept func(context.Context, chan<- Delivery) error, err error) {
				calls++
				return prev(a0)
			}
			atAssert = append(atAssert, func() (method string, errs []string) {
		...
		d.m.ListenForDeliveries = func(a0 context.Context) (accept func(context.Context, chan<- Delivery) error, err error) {
...
type SubscriptionDriverListenForDeliveriesMockDescriptor struct {
	...
	call         func(a0 context.Context) (accept func(context.Context, chan<- Delivery) error, err error)
	fileLine     string
}
...
// if called with values matching the expectations, will return.
func (d SubscriptionDriverListenForDeliveriesMockDescriptorWith1Arg) Returns(accept func(context.Context, chan<- Delivery) error, err error) SubscriptionDriverListenForDeliveriesMockDescriptorWithReturn {
	return d.ReturnsFrom(func(context.Context) (func(context.Context, chan<- Delivery) error, error) {
		return accept, err
	})
}
...
//
// It passes such passed values to a function that then returns the return values.
func (d SubscriptionDriverListenForDeliveriesMockDescriptorWith1Arg) ReturnsFrom(f func(a0 context.Context) (accept func(context.Context, chan<- Delivery) error, err error)) SubscriptionDriverListenForDeliveriesMockDescriptorWithReturn {
	d.methodDesc.call = f
...
func (m _makegomock_SubscriptionDriverMockFromMocker) ListenForDeliveries(a0 context.Context) (accept func(context.Context, chan<- Delivery) error, err error) {
...
type SubscriptionDriverMock interface {
	...
	ListenForDeliveries(a0 context.Context) (accept func(context.Context, chan<- Delivery) error, err error)
}
